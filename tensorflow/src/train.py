...
file name: train.py
    ...
    2. Uses elastic data augmentation to generate a good generalized model.

usage: python train.py --logdir=../logdir --ckdir=../models --outdir=../output --datadir=../data/image --labeldir=../data/label
--epochs=501 --batch-size=1 --cardinality=8 --reg=0.01 --learning-rate=0.0001 --classes=30 --data-augmentation
"""
# python imports
import os
import glob
...
def read_flags():
    ...
    parser.add_argument("--data-augmentation", action='store_true', default=False, help="If apply elastic deformation data augmentation")
...
def main(flags):
    ...
    pred = eneuronet(input_shape, X, cardinality, classes)
    ...
    ## training and validation data generator function
    def generator_tr():
